...
sp5
Makie.save("Torque_Trans.png", sp5)
...
lines!(ax, t, GRFd, color = :black, linewidth = 2, linestyle = :dash)
TransitionColor!(ax, t_all, GRF, swstance, :black, :solid, 2)
=#

ax = PlotSetUp(sp10[1,1], t.-t[1], GRFd, [1,length(t)], " ",L"t \text{, [s]}",L"R_{y_d} \text{, [N]}")
lines!(ax, t, GRFd, color = :black, linewidth = 2, linestyle = :dash)
Makie.scatter!(ax, [t[1], t[end]], [GRFd[1], GRFd[end]], color = :red, markersize = 20)

sp10
Makie.save("Stance_SSGRF.png", sp10)
